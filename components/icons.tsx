...
export const MicIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M6 10.5a.75.75 0 01.75.75v1.5a4.5 4.5 0 109 0v-1.5a.75.75 0 011.5 0v1.5a6 6 0 11-12 0v-1.5A.75.75 0 016 10.5zM12 18.75a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H12z" />
  </svg>
);
...
export const BrainIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.038-.502.068-.75.098m.75-.098a2.25 2.25 0 00-2.25-2.25H7.5A2.25 2.25 0 005.25 3.104M9.75 3.104c.251.038.502.068.75.098m-1.5.008v5.714a2.25 2.25 0 00.659 1.591L14.25 14.5M14.25 14.5h5.555a2.25 2.25 0 001.9-1.055l-1.9-1.055a2.25 2.25 0 00-1.9-1.055H14.25M14.25 14.5L9.75 10.364M5 14.5h5.555a2.25 2.25 0 011.9 1.055l-1.9 1.055a2.25 2.25 0 01-1.9 1.055H5m0 0a2.25 2.25 0 01-2.25-2.25V7.854a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25v2.25m-7.5 0h7.5" />
    </svg>
);
...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 01-9-9.75V5.625a1.125 1.125 0 011.125-1.125h16.5A1.125 1.125 0 0121 5.625v3.375c0 5.385-4.365 9.75-9.75 9.75z" />
    </svg>
);

export const AcademicCapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path d="M12 14.25c-2.093 0-4.14.403-6 1.182A13.43 13.43 0 003 21.692V22.5h18v-.808c0-2.43-1.045-4.7-2.903-6.26-1.857-1.56-4.16-2.43-6.597-2.43z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25A5.25 5.25 0 0017.25 9V6.375a.75.75 0 00-.528-.716l-4.5-1.5a.75.75 0 00-.444 0l-4.5 1.5A.75.75 0 006.75 6.375V9A5.25 5.25 0 0012 14.25z" />
    </svg>
);
